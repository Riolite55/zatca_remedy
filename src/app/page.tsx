...
const AnimatedChatPlaceholder = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] w-full space-y-6 animate-in fade-in zoom-in duration-500">
    <div className="relative w-32 h-32 flex items-center justify-center">
      <div className="absolute w-14 h-14 bg-blue-100 dark:bg-slate-800 rounded-2xl rounded-tr-sm right-2 top-2 animate-[bounce_3s_infinite]" />
      <div className="absolute w-16 h-16 bg-[#2053a4] rounded-2xl rounded-tl-sm left-2 bottom-2 animate-[bounce_3s_infinite_200ms] flex items-center justify-center shadow-lg">
        <Sparkles className="text-white w-8 h-8 animate-pulse" />
      </div>
      <div className="absolute w-6 h-6 bg-[#4fbbbd] rounded-full top-10 -left-2 animate-[ping_2s_infinite_400ms]" />
    </div>
    <div className="space-y-3 text-center">
      <h3 className="text-2xl font-semibold text-[#1d3761] dark:text-slate-200 tracking-tight">AI Analytical Chat</h3>
      <p className="text-slate-500 text-sm max-w-sm mx-auto leading-relaxed">
        Start a new conversation or select an existing one to generate instant insights from your Remedy data.
      </p>
    </div>
  </div>
);
          ...
          <div className="h-full flex flex-col bg-white dark:bg-slate-950">
            ...
            <ScrollArea className="flex-1 p-4 bg-slate-50/50 dark:bg-transparent min-h-0">
              <div className="flex flex-col gap-4 pb-4">
                {messages.length === 0 && <AnimatedChatPlaceholder />}
